...
public class FriendsService extends Service {
	...
	public void onCreate() {
		super.onCreate();
		Log.i(Hoothub.TAG, "Friends Service Started");
	}
	...
	public void onDestroy() {
		...
		Log.i(Hoothub.TAG, "Friends Service Stoped");
	}
	
	@Override
	public int onStartCommand(Intent intent, int flags, int startId) {
		super.onStartCommand(intent, flags, startId);
		Log.i(Hoothub.TAG, "Friends Service Recieved onStartCommand");
		...
		public void run() {
			...
			if (app.userAuthorized()) {
				try {
					...
					Group<User> friends = app.getApiClient().getFriends();
					app.getFriendsStorage().clear();
